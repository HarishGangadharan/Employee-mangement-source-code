...
<html>
   ...
   <body>
      <form id = "employee" method = "post" action = "employee">
         <div id="mySidenav" class="sidenav">
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
            <a href="home.jsp">Home</a>
            <input type="hidden" name="choice" value="Employee">
            <a onclick="document.getElementById('employee').submit();">Employee</a>
      ...
      <span id="id01" class="modal">
         <form class="modal-content animate" method = "post" action = "search">
            ...
            <div class="container">
               ...
               <input class = "submit" type="submit"   name = "choice" value = "Search"/>
            </div>
         </form>
      </span>
      <span id="id02" class="modal">
         <form class="modal-content animate" method = "post" action = "display">
      ...
      <span id="id03" class="modal">
         <form class="modal-content animate" method = "post" action = "EmployeeController">
         </form>
      </span>
